...
window.GAME_DATA = {
  ...
  tutorialSteps: [
    {
      title: "先選擇最適合你的閱讀方式",
      body: "網站提供正體中文、注音版與英文版；字級可選小、中、大。中與大字適合高齡者、兒童或需要較清楚閱讀的人，設定會保留在同一部裝置。"
    },
    {
      title: "歡迎來到宗族牌局",
      body: "你將在三輪之內與守藏者對戰。每輪雙方輪流行動，直到都選擇 PASS；本輪總分較高者取得一個勝場，先取得兩個勝場者獲勝。"
    },
    {
      title: "先看三類卡牌",
      body: "空間牌對應宗祠格局與場域，裝飾牌對應屋脊、斗栱、鳳眼、彩繪與文物，文字牌則對應堂號、匾額、楹聯、祖牌與祭祀文字。不同類型卡牌可依文化關係互相加分。"
    },
    {
      title: "開局先換牌",
      body: "第一輪開局前可換至多三張手牌，第二、三輪補牌後各可再換一張。換牌是整理組合技與保留資源的重要步驟。"
    },
    {
      title: "點一下閱讀，確認後才出牌",
      body: "點一下手牌只會選取並顯示遊戲效果，不會直接打出。快速點兩下同一張牌，才會正式出牌。這項設計可降低誤觸。"
    },
    {
      title: "每回合只有三種主要行動",
      body: "輪到你時，可打出一張牌、使用一次領主能力，或選擇 PASS。一旦 PASS，本輪不能再出牌，因此要同時判斷分數、手牌與剩餘輪次。"
    },
    {
      title: "組合技要從文化關係判斷",
      body: "組合技不會事先在棋盤上完整提示。你需要從卡牌效果、遊戲指南與文化內容理解哪些空間、裝飾及文字能互相連動；成功後系統才會播放動畫並記錄加分。"
    },
    {
      title: "文化標記只說文化特殊性",
      body: "常見、珍稀、史詩與傳說用來描述文化元素的特殊性、代表性或收藏價值。它們不增加力量、不改變技能，也不會讓電腦優先選擇高標記卡牌。"
    },
    {
      title: "桌機與手機都能查看完整說明",
      body: "桌機可將游標移到卡牌上查看效果，或按右鍵閱讀完整資料；手機與觸控裝置可先點選手牌，在手牌區閱讀效果。場上的卡牌可直接點擊查看詳細文化說明。"
    },
    {
      title: "牌局與文化支線可分開選擇",
      body: "你可以先玩牌，也可以從首頁直接進入文化支線。牌局結束後，系統會再次讓你選擇繼續玩牌、完成四條文化支線，或結束遊戲。"
    }
  ],
  ...
  cards: [
    {
      ...
      rarity: "常見",
      icon: "門",
      effectText: "啟動條件：本卡是己方第一張打出的空間牌。效果：本卡力量 +2。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "埕",
      effectText: "啟動條件：己方場上同時有「門樓」與「前堂」。效果：本卡力量 +4。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "前",
      effectText: "啟動條件：己方場上有「前堂斗栱彩繪」、「前堂門聯」、「寶樹堂」或「燕尾脊」。效果：每有 1 張指定連動牌，本卡力量 +2，最多 +4。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "井",
      effectText: "啟動條件：己方場上有其他空間牌。效果：每有 1 張其他空間牌，本卡力量 +1，最多 +4。",
    ...
    },
    {
      ...
      rarity: "史詩",
      icon: "後",
      effectText: "啟動條件：己方場上有「木本水源」或「祖牌與神位」。效果：本卡力量 +3。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "左",
      effectText: "啟動條件：己方場上有「右橫屋」。效果：本卡力量 +3。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "右",
      effectText: "啟動條件：己方場上有「左橫屋」。效果：本卡力量 +3。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "化",
      effectText: "啟動條件：己方場上有「五行石」或「土地龍神」。效果：本卡力量 +4。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "書",
      effectText: "啟動條件：己方場上有「左橫屋」或「右橫屋」。效果：本卡力量 +3。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "祭",
      effectText: "啟動條件：己方場上有文字牌。效果：每有 1 張文字牌，本卡力量 +1，最多 +3。",
...

    {
      ...
      rarity: "史詩",
      icon: "五",
      effectText: "啟動條件：己方場上有「化胎」。效果：本卡力量 +5。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "龍",
      effectText: "啟動條件：己方場上有「化胎」或「後堂」。效果：本卡力量 +4。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "爐",
      effectText: "啟動條件：己方場上有「後堂」。效果：本卡力量 +3。",
    ...
    },
    {
      ...
      rarity: "史詩",
      icon: "栱",
      effectText: "啟動條件：己方場上有「前堂」。效果：本卡力量 +5。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "元",
      effectText: "啟動條件：己方場上有「後堂」。效果：本卡力量 +4。",
    ...
    },
    {
      ...
      rarity: "史詩",
      icon: "樹",
      effectText: "啟動條件：己方場上有「寶樹堂」。效果：本卡力量 +5。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "男",
      effectText: "啟動條件：己方場上有「女燈」。效果：本卡力量 +4。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "女",
      effectText: "啟動條件：己方場上有「男燈」。效果：本卡力量 +4。",
    ...
    },
    {
      ...
      rarity: "史詩",
      icon: "燕",
      effectText: "啟動條件：己方場上有「門樓」或「前堂」。效果：本卡力量 +3。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "壽",
      effectText: "啟動條件：己方場上有「前堂」、「後堂」或「祭祀廳下」任一張。效果：本卡力量 +3。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "穀",
      effectText: "啟動條件：己方場上有「禾埕」。效果：本卡力量 +4。",
...

    {
      ...
      rarity: "史詩",
      icon: "寶",
      effectText: "啟動條件：己方場上有「前堂」或「蘋婆樹」。效果：本卡力量 +5。",
    ...
    },
    {
      ...
      rarity: "史詩",
      icon: "源",
      effectText: "啟動條件：己方場上有「後堂」。效果：本卡力量 +5。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "聯",
      effectText: "啟動條件：己方場上有「前堂」。效果：本卡力量 +4。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "倫",
      effectText: "啟動條件：己方場上至少有 3 張空間牌。效果：本卡力量 +5。",
    ...
    },
    {
      ...
      rarity: "傳說",
      icon: "祖",
      effectText: "啟動條件：己方場上有「後堂」或「祭祀廳下」。效果：本卡力量 +5。",
    ...
    },
    {
      ...
      rarity: "常見",
      icon: "謝",
      effectText: "啟動條件：己方場上有空間牌。效果：每有 1 張空間牌，本卡力量 +1，最多 +5。",
    ...
    },
    {
      ...
      rarity: "珍稀",
      icon: "祭",
      effectText: "啟動條件：己方場上至少有 2 張空間牌與 2 張文字牌。效果：本卡力量 +6。",
    ...
    },
    {
      ...
      rarity: "傳說",
      icon: "會",
      effectText: "啟動條件：己方三個出牌區皆至少有 1 張卡牌。效果：本卡力量 +5。",
