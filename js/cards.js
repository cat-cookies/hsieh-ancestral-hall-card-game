...
window.GAME_DATA = {
  ...
  tutorialSteps: [
    ...
    {
      title: "回合只有三種行動",
      body: "輪到你時，只能做三件事之一：打出一張牌、啟動一次領主能力、或直接 PASS。請注意，一旦 PASS，本輪就不能再出手。"
    },
    {
      title: "組合技不會事先提示",
  ...
  cards: [
    ...
    },
    {
      ...
      toastText: "五穀豐收圖樣連結農村生活、歲時與禾埕使用情境。",
      culturalNote: "五穀豐收圖樣是與農村生活經驗高度連動的裝飾題材。它與禾埕的活動情境、豐收想像及地方生產記憶互相映照，讓裝飾語彙與生活史脈絡連結起來。",
      source: "專題訪談整理"
    },
...
window.GAME_DATA.cardValueNotes = {
  ...
  harvestPattern: "五穀豐收圖樣把宗祠裝飾與農村生活連在一起。它反映地方社會對生產、歲時與豐收的期待，也讓建築裝飾具有清楚的生活史脈絡。",
